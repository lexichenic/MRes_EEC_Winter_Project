...
table.model.r.gt <- table.model.r %>% # align data into table
  gt::gt() %>% 
  cols_label(n=md("**n**"), # set column names
             k=md("**k**"),
  ...
  tab_source_note(source_note = md("n = number of studies; k = number of effects; CI = confidence interval; PI = prediction interval; *I*<sup>2</sup> = heterogeneity")) # footnotes for the table
...
```{r}
funnel(model,yaxis = "seinv",xlab = "Effect size") # plot a funnel plot for publication bias
```
